...
The next stage involved a systematic two-step process to organize data and identify and synthesize themes from the selected studies. First, the studies retrieved from online databases were organized and stored in Mendeley Desktop to ensure accurate referencing before being imported into Atlas.ti (version 24) for coding and data analysis. Atlas.ti enabled a cyclical and iterative approach to analyzing large amounts of data, a process that would have been difficult to replicate with word processing or spreadsheet tools. Importantly, while Atlas.ti does not replace the researcher’s critical role in analyzing and interpreting data, it greatly enhances methodological rigor, efficiency, and the overall quality of the research process. Furthermore, it streamlined data management and coding tasks while providing powerful visual analysis tools to uncover patterns, themes, and relationships that might otherwise remain obscured in a purely textual review.

The analysis proceeded through three consecutive rounds of coding and thematic synthesis, which culminated in the identification of final themes and concepts. It must be noted that this process was not machine-generated but relied on the researcher’s critical interpretation and judgment at every stage.

During the first round, thematic coding was employed to examine small data segments in detail and compare them with one another. This phase adhered to the themes outlined in the a priori framework while remaining open to adaptation. Codes in this stage represented a range of data points, including theoretical concepts, descriptive elements, or ideas deemed potentially significant for further analysis. Any data that did not fit within the a priori framework was incorporated through an inductive approach, allowing new themes and relationships to emerge organically from the data, thereby capturing a comprehensive range of relevant insights. Another advantage of using ATLAS.ti was its ability to provide direct access to the quotations upon which codes, themes, relationship maps, and other analytical constructs were based. This feature enabled continuous, context-based verification of the meanings assigned to concepts, helping to avoid the risk of treating concepts as independent entities without grounding them in the actual data.

In the second round, the analysis shifted toward grouping similar codes, merging them into higher-order categories, and continuously revisiting and refining these categories. Related or overlapping codes were consolidated, and underutilized codes that proved irrelevant or redundant were eliminated. This iterative process ensured that the thematic structure was both robust and parsimonious. 

The third round of analysis focused on selective coding, revisiting the data and codes to identify overarching themes, key concepts, and their interrelationships. Chains of codes and linked quotations were utilized to generate network diagrams, which highlighted connections within the data. Atlas.ti's mapping tools played a crucial role in this process, allowing for the retrieval and visualization of co-occurring codes through network diagrams and mapping features. Hyperlinked maps of quotations were also created, providing a direct means to address the research questions and further refine the analysis.
