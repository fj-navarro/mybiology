...
Table 4 Guiding points for future framework engagement, separated by development (or modification) and application
Framework process Guiding points
Development and/ or modification
Application/ use
• Explain the framework’s positioning: (1) who developed it, (2) the values of those research- ers, (3) the research questions engaged with, and (4) the field in which it is embedded. • Explain the purpose of the framework, for example, which paradigms, specific theories and models it is intended to contribute to. • Explain each of the frameworks compo- nents and relationships, and how they were conceived (i.e., through review/meta-analysis, expert knowledge, empirical work, opinion). • Explain how the framework can be applied by others to increase methodological learning and data cohesiveness. • Explain why the framework is novel and adds value compared to other existing frameworks
