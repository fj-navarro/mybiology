...
![Fig3. Buffon's evolution framework. Source: own elaboration](scheme-3.png)
...
The pattern in the case of the **analogy** is convergent, since two species A and B present the same organ with the same function.
